...
require_once 'app_config.inc.php';
...
/*
  ...
  |
 */
$config['base_url'] = defined('WEBSITE_BASE_URL') && !empty(WEBSITE_BASE_URL) ? WEBSITE_BASE_URL : $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['SERVER_NAME'];
...
$config['sess_cookie_name']        = 'ci_session' . SESSION_NAME;
