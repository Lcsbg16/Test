...
<option value="{$eAtual.id}" id="estacao_descricao" {if isset($smarty.get.estacoes) && $eAtual.id|in_array($smarty.get.estacoes)} selected{/if}> {$eAtual.descricao} ({$eAtual.identificador})</option>
                                        {/foreach}
                                    </select>
