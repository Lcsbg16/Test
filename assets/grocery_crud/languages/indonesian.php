...
/* Translated by: M. Yuhdi & Ibrahim Yusuf */
	...
	$lang['list_filtered_from']		= '(filtered from {total_results} total masukan data)';
	...
	$lang['error_on_uploading'] 		= "Terdapat kesalahan pada saat mengunggah.";
	...
	$lang['minimize_maximize'] 		= 'Memperkecil/Memperbesar';
	...
	$lang['list_more'] 			= 'Lebih';

	/* Added in version 1.5.6 */
	$lang['list_search_column'] 		= 'Cari {column_name}';

	/* Added in version 1.5.8 */
	$lang['alert_delete_multiple'] 		= 'Apakah Anda yakin akan menghapus seluruh {items_amount} data tersebut ?';

	$lang['alert_delete_multiple_one'] 	= 'Apakah Anda yakin akan menghapus 1 data ini ?';



	/* Added in version 1.6.1 */
	$lang['list_clone'] 			= 'Salin';
